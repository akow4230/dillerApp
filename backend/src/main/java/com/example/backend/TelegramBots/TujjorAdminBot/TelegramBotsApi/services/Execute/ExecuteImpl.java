...
import com.example.backend.TelegramBots.TujjorAdminBot.TelegramBotsApi.config.BotConfig;
...
public class ExecuteImpl implements Execute {
     ...
     */
    @Override
    public File send(GetFile getFile) {
        RestTemplate restTemplate = new RestTemplate();
        return restTemplate.postForObject(BotConfig.API_TELEGRAM + "/getFile", getFile, File.class);
    }
}
