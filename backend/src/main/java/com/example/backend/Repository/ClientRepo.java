...
""", nativeQuery = true)
    Page<Client> getClientsByActive(String active, String search, List<Integer> categoryIds, List<Integer> weekDayIds, String tin,List<UUID> territoryIds, Pageable pageRequest);
}
