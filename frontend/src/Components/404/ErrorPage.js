    ...
    return (
        <div className={"error-page"}>
            <main className={"error-main"}>
                <div>
                    <svg className="paper" viewBox="0 0 300 300" width="300px" height="300px" role="img"
                         aria-label="A piece of paper torn in half">
                        <g className="paper__outline" fill="none" stroke="hsl(0,10%,10%)" stroke-width="8"
                           stroke-linecap="round" stroke-linejoin="round" transform="translate(61,4)">
                            <g className="paper__top" transform="translate(0,25)">
                                ...
                                <rect className="paper__tear-fill" fill="hsl(0,0%,100%)" stroke="none" x="0" y="137"
                                      width="0" height="23px"/>
                ...
                <div>
                    ...
                    <p className={"error-p"}>We couldn’t find the page you were looking for. It may have been moved, or it just doesn’t
                        exist.</p>
                    <a className="btn-link" onClick={()=>navigate("/")}>Go Back Login</a>
                </div>
            </main>
        </div>
    );
