...
function TerritoryModal(props) {
    ...
    function handleMapClear() {
        dispatch({ type: 'territory/handleMapClear', payload: { mapState: territory.mapState, defValueOfMap: territory.defValueOfMap } });
    }

    function saveTerritory(data) {
        dispatch(
            props.isEditing
                ? editTerritoryAction({ territory: { ...data, longitude:territory?.longitude, latitude:territory?.latitude, id: props.data.id }, isEditing: true })
                : saveTerritoryAction({ territory: {...data,longitude:territory?.longitude, latitude:territory?.latitude}, isEditing: false })
        );
