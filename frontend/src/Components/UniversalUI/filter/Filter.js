...
import {changeSearchParams, getSearchData} from "../../../redux/reducers/TableSlice";
        ...
        <div className="">
            <div className="row">
                ...
                {obj.length !== 0 || obj.length === 1 && obj[0] !== 'active' ? (
                    <button onClick={getSearchData} style={{ width: '90px' }} className="my-2 h-50 btn btn-primary">
                        Filter
                    </button>
                ) : (
                    ''
